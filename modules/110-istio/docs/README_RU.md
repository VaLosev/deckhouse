...
|:------------:|:------------------------------------------------------------------------------------------------------------------------------:|:--------------------------:|
|     1.16     |                                           1.22<sup>*</sup>, 1.23<sup>*</sup>, 1.24<sup>*</sup>, 1.25<sup>*</sup>                                            |  Устарела и будет удалена  |
|     1.19     |                                                     1.25<sup>*</sup>, 1.26, 1.27, 1.28, 1.29, 1.30                                                     |       Поддерживается       |
...
* `kiali` — панель управления и наблюдения за ресурсами Istio и пользовательскими сервисами под управлением Istio, позволяющая:
